/* Program uses EVD class to solve the s-wave radial Schrödinger eq. for the hydrogen atom. */
...
class Program
    {
        static void Main(string[] args)
        {
            ...
            if (secondWaveVector[0] < 0) // Sometimes the numerical solution, randomly assigns a sign to the entire solution.
            {
                secondWaveVector *= -1;
            }
