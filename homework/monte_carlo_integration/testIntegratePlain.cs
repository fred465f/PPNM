/* Program tests implementation of plain Monte-Carlo integrator in MonteCarloIntegrator class.
Estimated error is compared to actual error, and error scaling is checked to go as 1/sqrt(N). 
This is done by outputting data to standard output stream for later plotting. */
...
class Program
{
    public static void Main()
    {
        ...
        {
            // Compute integral.
            (double estimatedAreaOfCircle, double estimatedError) = MonteCarloIntegrator.IntegratePlain(f, a, b, N);
